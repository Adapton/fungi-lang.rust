...
mod trapdoor {
    ...
    pub fn vec_filter(args:Vec<RtVal>) -> ExpTerm {
    ...
    pub fn vec_map(args:Vec<RtVal>) -> ExpTerm {
        // map(vector, userfun)
        match (&args[0], &args[1]) {
            _ => panic!("TODO")
        }
    ...
    pub fn vec_fold(args:Vec<RtVal>) -> ExpTerm {
    ...
    pub fn vec_fold_rev(args:Vec<RtVal>) -> ExpTerm {
